...
Componente: `AracneSpiderEffect`, en `ui/components/spiderEffect/`. Nació en la
rama `desarrollo/entidad-aracnida` y está en `main` desde el 18 de septiembre
de 2026, cuando se aprobó la cuarta excepción de `CLAUDE.md`.
